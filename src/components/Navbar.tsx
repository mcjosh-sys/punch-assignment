...
const Navbar = () => {
  ...
  return (
    <Sheet>
      <nav
        className={cn(
          "navbar fixed z-50 bg-primary rounded-lg w-full max-w-[1300px] h-[60px] hidden sl:flex items-center justify-between mt-9 mx-[70px] flex-1",
          {
            active: show,
            hidden: !show,
          }
        ...
        <div className="flex items-center">
          ...
          <a
            href="#"
            className="bg-white rounded-lg px-5 py-[0.6rem]  mx-2 hover:bg-secondary transition-colors duration-300">
            Join Now
          </a>
        </div>
      </nav>
      ...
      <SheetContent>
        <div className="h-full w-full flex flex-col mt-20 gap-6">
          ...
          <div className="flex justify-center gap-8 px-4">
            <a
              className="relative group border-2 py-2 px-5 bg-slate-500 text-white rounded-lg overflow-hidden"
              href="#">
            ...
            <a
              href="#"
              className="relative group bg-secondary flex items-center border-2 py-2 px-5 rounded-lg overflow-hidden">
